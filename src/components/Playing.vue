  ...
  <div class="playnow-container" v-if="playNow.id && allSongs[playNow.id]">
    <div class="progress-container" v-if="playNow.al && playNow.al.picUrl">
      <el-progress
        ...
        :show-text="false"
      />
      <img :class="`progress-cover playing-${!downloading && playing}`" :src="`${playNow.al.picUrl || 'http://p2.music.126.net/ftPcA5oCeIQxhiNmEpmtKw==/109951163926974610.jpg'}?param=300y300`" alt="">
    </div>
    <div class="song-info">
      <div class="info-line">
