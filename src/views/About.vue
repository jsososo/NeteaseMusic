    ...
    data() {
      return {
        history: [
          ...
          {
            txt: '🤤 企鹅音乐评论、点赞 & 咪咕歌单无法显示',
            time: '20-02-16',
          },
          {
            txt: '🦋 单曲列表播放、随机播放排序优化、上一首有时会跳两首优化',
            time: '20-02-21',
          },
          {
            txt: '🐜 歌词定位播放、歌单播放定位、批量下载增加放封延时',
            time: '20-03-04',
          },
          {
            txt: '🦊 FireFox 兼容性问题',
          ...
          {
            txt: '🍃 去除 cookie 中 uin 的其他字母',
            time: '20-03-22',
          },
          {
            txt: '🌸 mp3 下载支持封面（flac也太难了吧！',
            time: '20-03-23',
          }
        ],
        future: [
